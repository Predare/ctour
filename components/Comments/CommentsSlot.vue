...
<template>
    <div class="flex flex-row gap-4">
        ...
        <div class="w-100">
            ...
            <CommentsForm class="mb-[1rem]" v-if="showForm" :postLink="api.post" :closeForm="closeForm"
                :add-comment="addSubcomment" :comments="subComments"></CommentsForm>
            ...
            <CommentsSlot class="mt-5" v-if="freshSubcomment && !showReplies" :key="freshSubcomment.id"
                ...
                :userName="freshSubcomment.user.name" :user-avatar="freshSubcomment.user.avatar"
                :userAvatarColor="freshSubcomment.user.color" :userRankColor="freshSubcomment.user.rank.color"
                :userRankName="freshSubcomment.user.rank.name" :text="freshSubcomment.text"
                :created-at="freshSubcomment.createdAt" :positive-votes="freshSubcomment.positiveVotes"
                :negative-votes="freshSubcomment.negativeVotes" :vote-status="freshSubcomment.voteStatus"
                :addReplySubcomment="addSubcomment" />
